  ...
  <div class="policies-review container-fluid">
    <div class="card mb-5">
      <div class="card-body cert-block">
        <h4 class="card-title form-sub-title mb-4">Buy a New Truck or Trailer</h4>

        <div v-if="loading">Loading...</div>
        <div v-if="status">
          <div v-for="item in trucks" :key="item.id" class="d-flex block-divider">
            ...
            <div class="pl-4">
              ...
              <div class="block-subtitle mb-2">{{ item.content }}</div>
            </div>
          </div>
        </div>
        <div v-else>
